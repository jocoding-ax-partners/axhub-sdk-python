...
ERROR_CODES = {
    ...
    "synology_invalid_credential": ErrorInfo("validation", 400, False),
    "synology_probe_failed": ErrorInfo("unavailable", 502, True),
    "synology_relay_unreachable": ErrorInfo("validation", 502, False),
